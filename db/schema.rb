...
ActiveRecord::Schema[8.0].define(version: 2026_09_15_150000) do
  ...
  create_table "board_images", force: :cascade do |t|
    ...
    t.integer "border_width", default: 0, null: false
    t.integer "border_radius", default: 0, null: false
  ...
  create_table "board_printable_listings", force: :cascade do |t|
    t.bigint "board_printable_id", null: false
    t.bigint "etsy_listing_id"
    t.string "etsy_listing_url"
    t.string "state", default: "pending", null: false
    t.string "purpose", default: "standalone", null: false
    t.string "label"
  ...
  create_table "kit_pages", force: :cascade do |t|
    ...
    t.jsonb "preview_settings", default: {}, null: false
  ...
  add_foreign_key "board_printable_listings", "board_printables"
