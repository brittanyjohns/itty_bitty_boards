...
Rails.application.routes.draw do
  ...
  namespace :admin do
    ...
    resources :scene_templates, only: %i[index new create edit update destroy], as: :dashboard_scene_templates do
      # A scene built from a magenta-marked image: generated by AI (paid), or
      # uploaded. Both detect slots in a job; `generation` is the status page.
      collection do
        post :generate
        post :upload_marked
      end
  ...
  namespace :api, defaults: { format: :json } do
    ...
    resources :board_images do
      member do
        ...
        post "create_text_image", to: "board_images#create_text_image"
