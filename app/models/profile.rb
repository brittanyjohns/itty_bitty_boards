...
class Profile < ApplicationRecord
  ...
  # [variant, size] pair the generator offers. PDF only — a PNG of a
  # multi-page or fixed-layout document is meaningless. Deliberately NOT
  # generated by #generate_attachments!; they're built on demand from the
  # endpoint so a profile save doesn't pay for more Grover renders. See
