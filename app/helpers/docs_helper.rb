module DocsHelper
  ...
  def remove_doc_button(doc)
    ...
    button_to "#{icon("fa-solid", "trash")}".html_safe, doc, method: :delete, data: { confirm: "Are you sure?", turbo_confirm: "Are you sure you want to delete this image doc? This action cannot be undone." }, class: "absolute bottom-0 right-0 m-4 text-red-400 font-bold p-1 rounded bg-white"
  end
end
