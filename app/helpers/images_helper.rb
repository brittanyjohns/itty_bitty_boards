    ...
    def display_image_for(image, user)
      ...
      return "" if user_image.blank?
        ...
        if !user_image.attached?
          str += "<div class='h-100 w-52 text-gray-400 text-2xl font-bold grid justify-items-center items-center shadow mx-auto my-auto'><span class='mx-auto my-auto'>#{image.label.upcase}</span></div>".html_safe
        else
