...
RSpec.describe PartnerMailer, type: :mailer do
  ...
  describe "#welcome_email" do
    ...
    it "renders the English subject and body" do
      ...
      expect((mail.html_part || mail).body.decoded).to include("Hi <strong>Pat</strong>")
      expect((mail.html_part || mail).body.decoded).to include("SpeakAnyWay Partner Program")
      expect((mail.html_part || mail).body.decoded).to include("Go to the Partner Portal")
    end

    it "does not use retired terminology (Pilot / MySpeak ID)" do
      use_locale(user, "en-US")
      message = described_class.welcome_email(user).deliver_now
    ...
    it "renders the Spanish subject and body" do
      ...
      expect((mail.html_part || mail).body.decoded).to include("Hola <strong>Pat</strong>")
      expect((mail.html_part || mail).body.decoded).to include("Programa de Socios de SpeakAnyWay")
      expect((mail.html_part || mail).body.decoded).to include("Ir al Portal de Socios")
    end
  ...
  describe "#pilot_ending_email" do
    ...
    it "renders the English subject and body with the CTA" do
      ...
      expect((mail.html_part || mail).body.decoded).to include("Add a card to keep Partner Pro")
    end
