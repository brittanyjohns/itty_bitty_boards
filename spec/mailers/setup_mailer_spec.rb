...
RSpec.describe SetupMailer, type: :mailer do
  ...
  describe "#myspeak_setup_email" do
    ...
    it "renders the English subject and body" do
      ...
      expect((mail.html_part || mail).body.decoded).to include("Your MySpeak Profile")
    end
    ...
    it "renders the Spanish subject and body" do
      ...
      expect((mail.html_part || mail).body.decoded).to include("bienvenida a MySpeak")
      expect((mail.html_part || mail).body.decoded).to include("Hola Pat")
      expect((mail.html_part || mail).body.decoded).to include("Tu perfil de MySpeak")
    end
  end
  ...
  describe "#basic_setup_email" do
    ...
    it "renders the English subject and body" do
      ...
      expect((mail.html_part || mail).body.decoded).to include("Welcome to SpeakAnyWay Basic!")
      expect((mail.html_part || mail).body.decoded).to include("Hi Pat")
      expect((mail.html_part || mail).body.decoded).to include("Get Started Now!")
    end
    ...
    it "renders the Spanish subject and body" do
      ...
      expect((mail.html_part || mail).body.decoded).to include("SpeakAnyWay Basic")
      expect((mail.html_part || mail).body.decoded).to include("Hola Pat")
      expect((mail.html_part || mail).body.decoded).to include("¡Empezar ahora!")
    end
  end
  ...
  describe "#pro_setup_email" do
    ...
    it "renders the English subject and body" do
      ...
      expect((mail.html_part || mail).body.decoded).to include("Hi Pat")
      expect((mail.html_part || mail).body.decoded).to include("Pro Account")
    end
    ...
    it "renders the Spanish subject and body" do
      ...
      expect((mail.html_part || mail).body.decoded).to include("SpeakAnyWay Pro")
      expect((mail.html_part || mail).body.decoded).to include("Hola Pat")
      expect((mail.html_part || mail).body.decoded).to include("cuenta Pro")
    end
  end
  ...
  describe "#vendor_setup_email" do
    ...
    it "renders the English subject and body" do
      ...
      expect((mail.html_part || mail).body.decoded).to include("Welcome to SpeakAnyWay Vendor Hub!")
      expect((mail.html_part || mail).body.decoded).to include("Hi Pat")
      expect((mail.html_part || mail).body.decoded).to include("Set Up My Vendor Page")
    end
    ...
    it "renders the Spanish subject and body" do
      ...
      expect((mail.html_part || mail).body.decoded).to include("Centro de Proveedores de SpeakAnyWay")
      expect((mail.html_part || mail).body.decoded).to include("Hola Pat")
      expect((mail.html_part || mail).body.decoded).to include("Configurar mi página de Proveedor")
    end
  end
