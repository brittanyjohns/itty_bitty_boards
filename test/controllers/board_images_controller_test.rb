...
class BoardImagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create board_image" do
    assert_difference("BoardImage.count") do
      post board_images_url, params: { board_image: { board_id: @board_image.board_id, image_id: @board_image.image_id, position: @board_image.position } }
    end
  ...
  test "should update board_image" do
    patch board_image_url(@board_image), params: { board_image: { board_id: @board_image.board_id, image_id: @board_image.image_id, position: @board_image.position } }
